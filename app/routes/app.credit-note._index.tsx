...
const creditNoteListCache = createAppPageClientCache();

export async function clientLoader(args: ClientLoaderFunctionArgs) {
  return cachedClientLoader(creditNoteListCache, args);
}
...
export function shouldRevalidate({
  ...
  if (defaultShouldRevalidate) creditNoteListCache.bust();
...
export function ErrorBoundary() {
  return renderEmbeddedRouteError(useRouteError(), "billoxi:credit-note-list-reload");
}
